...
MEDIA_ROOT = f"{BASE_DIR}/courses/static/"  # lấy đường dẫn này vào thuộc tính upload_to
...
SECRET_KEY = 'django-insecure-ku63cpepdl+l488imw*n6eyu900eqc!ta2r!6ha0i^hz%8d06v'
